let currentPage = 1;
let totalPages = parseInt(document.getElementById('regularstorecontainer').dataset.regularstorepage);
const regularProductsContainer = document.getElementById('regularstorecontainer');
